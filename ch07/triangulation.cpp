...
int main(int argc, char** argv) {
    ...
    for(int i = 0; i < matches.size(); i++) {
        ...
        cv::circle(img1_plot, keypoints_1[matches[i].queryIdx].pt, 2, get_color(depth), 2);
...
void pose_estimation_2d2d(
    ...
    for(int i = 0; i < matches.size(); i++) {
        points1.push_back(pixel2cam(keypoints_1[matches[i].queryIdx].pt, K));
        points2.push_back(pixel2cam(keypoints_2[matches[i].trainIdx].pt, K));
    }
